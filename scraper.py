...
DRIVER_PATH = ("C:/Users/joshu/Python Projects/Machine Learning Projects/Web Image Classifier/chromedriver.exe")
...
def persist_image(folder_path:str,url:str):
    ...
    try:
        ...
        path_list.append(hashlib.sha1(image_content).hexdigest()[:10] + '.jpg')
...
df = pd.DataFrame(path_list, columns = ["filenames"])
csv_path = "img_names/" + search_term
